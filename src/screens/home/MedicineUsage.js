...
// THEME
import { SPACING, defaultBackground, cardBackground, width, height, topOS } from '../../config/theme';
    ...
    return (
        ...
        <View style={{backgroundColor: defaultBackground, flex: 1,}}>
            <FlatList
                ...
                data={filteredData && filteredData.length > 0 ? filteredData : MedicineUsageList}
