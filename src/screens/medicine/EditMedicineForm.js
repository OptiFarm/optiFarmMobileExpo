...
export default function EditMedicineForm({ navigation, route }) {
  // GET MEDICINE DETAILS FROM PREVIOUS PAGE
  ...
  const onSubmit = (data) => {
    ...
    const purchase_date = data.dateOfPurchase;
  ...
  const placeholderType = {
    label: item.medicine_type,
    value: null,
  };

  const placeholderQuantity = {
    label: item.quantity_type,
    value: null,
  };
